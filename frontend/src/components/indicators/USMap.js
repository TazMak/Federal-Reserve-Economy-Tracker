...
/**
 * USMap component - Renders an interactive SVG map of the United States
 * Each state is clickable and can be colored based on data values
 * 
 * @param {Object} stateColors - Object mapping state codes to color data {color: string, value: number}
 * @param {Function} onStateClick - Callback function when a state is clicked, receives state code
 * @returns {JSX.Element} Interactive US map SVG
 */
const USMap = ({ stateColors = {}, onStateClick }) => {
  // Helper function to get the fill color for a state
  const getStateFill = (stateCode) => {
    if (stateColors && stateColors[stateCode]) {
      return stateColors[stateCode].color;
    }
    return '#D3D3D3'; // Default light gray for states without data
  };
  ...
  return (
    <div className="us-map-container">
      ...
      >
        ...
        {/* Alaska - simplified for map view */}
        <path
        ...
        {/* Georgia */}
        <path
          d="M 671.8 354.2 L 673.8 356.2 L 677.8 356.2 L 680.8 357.2 L 682.8 357.2 L 685.8 361.2 L 687.8 366.2 L 689.8 369.2 L 691.8 373.2 L 693.8 376.2 L 696.8 376.2 L 696.8 378.2 L 695.8 381.2 L 695.8 384.2 L 693.8 387.2 L 692.8 390.2 L 689.8 395.2 L 687.8 397.2 L 686.8 400.2 L 683.8 402.2 L 682.8 402.2 L 681.8 405.2 L 678.8 409.2 L 677.8 411.2 L 676.8 414.2 L 673.8 415.2 L 671.8 415.2 L 669.8 417.2 L 668.8 419.2 L 668.8 422.2 L 665.8 424.2 L 663.8 426.2 L 659.8 428.2 L 659.8 430.2 L 658.8 432.2 L 656.8 435.2 L 653.8 437.2 L 653.8 439.2 L 653.8 442.2 L 651.8 442.2 L 649.8 444.2 L 642.6 442.7 L 637.6 440.9 L 633.3 440.2 L 633.8 437.2 L 632.8 434.2 L 631.8 431.2 L 631.8 425.2 L 634.8 421.2 L 635.8 418.2 L 637.8 417.2 L 638.8 413.2 L 640.8 409.2 L 641.8 405.2 L 640.8 404.2 L 639.8 402.2 L 637.8 400.2 L 637.8 396.2 L 636.8 393.2 L 634.8 392.2 L 632.8 391.2 L 629.8 391.2 L 628.8 392.2 L 625.8 392.2 L 621.8 391.2 L 619.8 389.2 L 618.8 386.2 L 616.8 384.2 L 615.8 382.2 L 615.8 379.2 L 616.8 376.2 L 616.8 371.2 L 617.8 367.2 L 618.8 364.2 L 621.8 360.2 L 626.8 356.2 L 630.8 354.2 L 635.8 352.2 L 639.8 350.2 L 644.8 349.2 L 648.8 351.2 L 652.8 351.2 L 658.8 348.2 L 661.8 347.2 L 662.8 347.2 L 663.8 351.2 L 665.8 353.2 L 669.8 353.2 Z"
          id="GA"
        ...
        {/* New Mexico */}
        <path
          d="M 358.1 411.7 L 358.1 413.7 L 358.1 414.7 L 359.1 414.7 L 359.1 432.7 L 359.1 439.7 L 291.1 442.7 L 268.1 442.7 L 267.1 442.7 L 266.1 439.7 L 266.1 434.7 L 264.1 428.7 L 264.1 409.7 L 266.1 399.7 L 269.1 400.7 L 270.1 398.7 L 270.1 395.7 L 269.1 391.7 L 269.1 386.7 L 271.1 385.7 L 271.1 383.7 L 274.1 381.7 L 277.1 378.7 L 280.1 375.7 L 283.1 372.7 L 288.1 369.7 L 291.1 367.7 L 292.1 365.7 L 295.1 363.7 L 296.1 363.7 L 298.1 361.7 L 301.1 361.7 L 304.1 361.7 L 305.1 358.7 L 306.1 355.7 L 310.1 357.7 L 360.1 364.7 L 360.1 382.7 L 359.1 398.7 Z"
          id="NM"
        ...
        className="state-path"
        />
        // Texas (continued from previous file)
        <path
        ...
        {/* Washington */}
        <path
        d="M 161.1 83.6 L 163.1 85.6 L 165.1 85.6 L 172.1 86.6 L 176.1 87.6 L 181.1 89.6 L 186.1 90.6 L 190.1 90.6 L 196.1 88.6 L 198.1 86.6 L 199.1 83.6 L 199.1 81.6 L 198.1 79.6 L 199.1 77.6 L 199.1 74.6 L 198.1 72.6 L 196.1 70.6 L 195.1 68.6 L 193.1 66.6 L 190.1 65.6 L 187.1 64.6 L 184.1 63.6 L 182.1 62.6 L 177.1 62.6 L 173.1 63.6 L 170.1 65.6 L 167.1 67.6 L 164.1 69.6 L 161.1 70.6 L 158.1 71.6 L 155.1 71.6 L 152.1 70.6 L 150.1 68.6 L 148.1 65.6 L 148.1 63.6 L 146.1 59.6 L 145.1 57.6 L 142.1 53.6 L 140.1 49.6 L 137.1 47.6 L 133.1 43.6 L 130.1 43.6 L 128.1 42.6 L 126.1 39.6 L 125.1 36.6 L 123.1 31.6 L 122.1 28.6 L 121.1 25.6 L 119.1 22.6 L 117.1 19.6 L 115.1 17.6 L 113.1 15.6 L 110.1 14.6 L 108.1 13.6 L 106.1 11.6 L 104.1 10.6 L 102.1 10.6 L 100.1 12.6 L 98.1 14.6 L 96.1 17.6 L 93.1 19.6 L 91.1 22.6 L 90.1 25.6 L 88.1 28.6 L 85.1 32.6 L 82.1 35.6 L 79.1 39.6 L 76.1 42.6 L 73.1 44.6 L 71.1 48.6 L 69.1 51.6 L 67.1 55.6 L 66.1 59.6 L 64.1 62.6 L 63.1 66.6 L 62.1 69.6 L 60.1 74.6 L 59.1 78.6 L 59.1 82.6 L 57.1 85.6 L 130.1 100.6 L 142.1 103.6 L 161.1 107.6 L 162.1 98.6 L 161.1 91.6 Z"
        id="WA"
        ...
        {/* West Virginia */}
        <path
        d="M 737.5 240.4 L 735.5 242.4 L 732.5 246.4 L 730.5 248.4 L 727.5 250.4 L 724.5 252.4 L 722.5 254.4 L 719.5 255.4 L 715.5 255.4 L 712.5 255.4 L 710.5 255.4 L 709.5 254.4 L 704.5 250.4 L 701.5 248.4 L 697.5 248.4 L 694.5 249.4 L 691.5 250.4 L 687.5 251.4 L 684.5 252.4 L 681.5 254.4 L 680.5 256.4 L 678.5 256.4 L 677.5 254.4 L 675.5 252.4 L 674.5 249.4 L 672.5 245.4 L 671.5 242.4 L 669.5 240.4 L 669.5 237.4 L 668.5 233.4 L 667.5 229.4 L 667.5 226.4 L 665.5 222.4 L 665.5 219.4 L 666.5 215.4 L 668.5 211.4 L 669.5 207.4 L 670.5 205.4 L 672.5 203.4 L 674.5 201.4 L 675.5 198.4 L 677.5 195.4 L 678.5 191.4 L 680.5 187.4 L 682.5 184.4 L 684.5 182.4 L 686.5 181.4 L 689.5 180.4 L 692.5 181.4 L 694.5 183.4 L 696.5 185.4 L 699.5 188.4 L 702.5 189.4 L 706.5 191.4 L 710.5 192.4 L 711.5 195.4 L 713.5 196.4 L 715.5 198.4 L 718.5 199.4 L 720.5 203.4 L 721.5 205.4 L 724.5 205.4 L 726.5 206.4 L 729.5 208.4 L 732.5 208.4 L 734.5 210.4 L 736.5 209.4 L 737.5 212.4 L 737.5 214.4 L 738.5 217.4 L 737.5 219.4 L 737.5 222.4 L 736.5 225.4 L 735.5 228.4 L 733.5 231.4 L 731.5 234.4 L 732.5 237.4 L 735.5 240.4 Z"
        id="WV"
        ...
        {/* Wisconsin */}
        <path
        d="M 590.6 169.8 L 588.6 172.8 L 587.6 175.8 L 587.6 178.8 L 588.6 180.8 L 590.6 184.8 L 591.6 187.8 L 591.6 190.8 L 589.6 194.8 L 589.6 197.8 L 590.6 200.8 L 593.6 203.8 L 593.6 205.8 L 594.6 207.8 L 596.6 208.8 L 595.6 213.8 L 593.6 218.8 L 592.6 221.8 L 590.6 224.8 L 588.6 228.8 L 587.6 230.8 L 584.6 232.8 L 581.6 234.8, L 580.6 237.8 L 577.6 239.8 L 575.6 241.8 L 572.6 243.8 L 571.6 245.8 L 569.6 247.8 L 566.6 248.8 L 563.6 248.8 L 557.6 246.8 L 554.6 244.8 L 553.6 241.8 L 551.6 239.8 L 549.6 237.8 L 547.6 235.8 L 547.6 233.8 L 545.6 231.8 L 543.6 228.8 L 542.6 225.8 L 542.6 222.8 L 540.6 220.8 L 538.6 219.8 L 536.6 216.8 L 536.6 212.8 L 538.6 210.8 L 538.6 207.8 L 536.6 205.8 L 536.6 202.8 L 536.6 199.8 L 536.6 197.8 L 536.6 194.8 L 535.6 192.8 L 534.6 190.8 L 534.6 188.8 L 534.6 184.8 L 534.6 182.8 L 534.6 178.8 L 534.6 173.8 L 535.6 169.8 L 538.6 168.8 L 542.6 168.8 L 547.6 169.8 L 552.6 168.8 L 558.6 168.8 L 564.6 169.8 L 567.6 170.8 L 571.6 170.8 L 574.6 171.8 L 577.6 170.8 L 579.6 170.8 L 582.6 169.8 L 586.6 169.8 Z"
        id="WI"
        ...
        {/* Wyoming */}
        <path
        d="M 360.3 223.6 L 362.3 268.6 L 308.3 262.6 L 272.3 258.6 L 271.3 258.6 L 266.3 215.6 L 264.3 192.6 L 262.3 175.6 L 262.3 174.6 L 273.3 175.6 L 295.3 178.6 L 318.3 180.6 L 341.3 183.6 L 353.3 184.6 L 359.3 185.6 L 359.3 222.6 Z"
        id="WY"
        ...
        {/* Washington, D.C. (small for map view) */}
        <path
          d="M 772.3 240.5 L 771.3 241.5 L 770.3 242.5 L 769.3 243.5 L 768.3 243.5 L 768.3 242.5 L 769.3 241.5 L 770.3 240.5 L 771.3 239.5 L 772.3 239.5 Z"
          id="DC"
          fill={getStateFill('DC')}
          onClick={() => onStateClick('DC')}
          className="state-path"
        />
      </svg>
    </div>
